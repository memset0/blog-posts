...
![65GC8mud.png|505](https://static.memset0.cn/img/v6/2024/09/05/65GC8mud.png)

如果将邻接矩阵改为概率矩阵，就可以得到随机的 Kronecker 图。在图过大时，可以不用判断每条边是否存在，而是采用采样的思想不断添加边。

![6JehYrzC.png|182](https://static.memset0.cn/img/v6/2024/09/05/6JehYrzC.png)
...
![B6XukKqf.png|523](https://static.memset0.cn/img/v6/2024/09/05/B6XukKqf.png)

这个过程也可以看做是在逐渐补全一个邻接矩阵

![8.png|278](https://static.memset0.cn/img/v6/2024/09/05/Km8jpp11.png)
...
![u07WF7IZ.png|554](https://static.memset0.cn/img/v6/2024/09/05/u07WF7IZ.png)
