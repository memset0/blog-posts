...
![|510](https://img.memset0.cn/2024/11/18/YOo3XiO1.png)

### 2.4. Three Walls

Power Wall：以 CMOS IC technology 为例，其**能耗(power)** 公式为：（**电容负载(capacitive load)**）

$$
\text{Power} = \text{Capacitive load} \times \text{Voltage}^2 \times \text{Frequency}
$$

![|391](https://img.memset0.cn/2024/11/18/IhaQZkvp.png)
