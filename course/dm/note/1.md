...
### 5.3. 证明方法 Proof Methods

#### 5.3.1. 直接证明法 Direct Proof
...
#### 5.3.2. 空证明和平凡证明 Vacuous and Trivial Proof
...
#### 5.3.3. 反证法 Proof by Contraposition
...
#### 5.3.4. 归谬证明法 Proof by Contradiciton
