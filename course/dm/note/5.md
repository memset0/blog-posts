...
### 3.2. 允许重复的排列组合问题 Permutation and Combination with Repetition
...
### 3.3. 关于小球盒子的问题 Distributing Objects into Boxes
...
![Pl13Ac1M.png|539](https://static.memset0.cn/img/v6/2024/04/16/Pl13Ac1M.png)
...
### 6.2. 广义二项式定理 The Extended Binomial Theorem

> [!summary] Definition: Extend Binomial Coefficient
>
...
> [!important] Theorem: The Extended Binomial Theorem
...
### 6.3. Some Common Used Generating Functions
...
### 6.4. Solve Counting Problems with Generating Function

> [!example] Section 8.4 Example 9
...
### 6.5. Solve Recurrence Relations with Generating Function

> [!example] Section 8.4 Example
>
