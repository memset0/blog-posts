...
![|500](https://static.memset0.cn/img/v6/2024/02/26/qXVDgA80.png)
...
![（这里红色节点代表 X，黄色节点代表 P）|600](https://static.memset0.cn/img/v6/2024/02/26/gn7NSlBu.png)
...
![Zig-Zig|500](https://static.memset0.cn/img/v6/2024/02/26/5hObMV2e.png)

若不在，则应用 Zig-Zag 操作，旋转 $Rotate(X),\,Rotate(X)$（虽然都是旋转同一个点，但是两次旋转的方向不同）：

![Zig-Zag|500](https://static.memset0.cn/img/v6/2024/02/26/E1wvUUKl.png)
...
![|600](https://static.memset0.cn/img/v6/2024/03/04/npUGjy8F.png)
...
- **Step 2**：自底向上处理连续的红节点的问题，分以下三种情况讨论：
   ...
   ![|300](https://static.memset0.cn/img/v6/2024/03/04/yKhJJP8i.png)
...
![B+ 树示意图|450](https://static.memset0.cn/img/v6/2024/03/06/tbIAaCu7.png)
...
![课件中给出的伪代码|500](https://static.memset0.cn/img/v6/2024/03/06/TDgpEcGD.png)

### 4.3. 复杂度分析

一般来说我们取 $M=3$（2-3 树）或 $M=4$（2-3-4 树）。当 $M$ 不是常数级别时，需要用二分查找对插入过程进行优化。（TBD）