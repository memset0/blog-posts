...
### 2.4. 扩展关系代数操作 | Extended Relational-Algebra-Operations

- **广义投影(Generalized Projection)**
- **聚合函数(Aggregate Functions)**

### 2.5. 广义投影 | Generalized Projection

- 通过允许在投影列表中使用算术函数来扩展投影操作。
- $E$ 是任何关系代数表达式。
- $F_1, F_2, ..., F_n$ 是涉及常数和 $E$ 模式中的属性的算术表达式。

### 2.6. 聚合函数和操作 | Aggregate Functions and Operations
...
### 2.7. 聚合函数（续） | Aggregate Functions (Cont.)

- 聚合的结果没有名称。
    - 可以使用重命名操作为其命名。
    - 为了方便起见，我们允许在聚合操作中进行重命名。

### 2.8. 数据库的修改 | Modification of the Database
...
### 2.9. 多重集关系代数 | Multiset Relational Algebra
