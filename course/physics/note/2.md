---
title: II. 刚体力学
# published-title: 「大学物理(乙)」II. 刚体力学
sync: /course/physics/note/2.md
create-date: 2024-04-24 17:56:58
cover: https://img.memset0.cn/2024/10/26/CQfQYJGt.png
---

> 本篇笔记主要介绍了刚体力学的基本概念和定律。首先定义了刚体模型，然后讨论了刚体的质心运动，包括平动、质心坐标和质心运动定理。接着探讨了刚体的定轴转动，介绍了转动平面的概念以及角位移、角速度和角加速度等物理量。最后还提到了匀变速定轴转动的相关公式。这些内容为理解和分析刚体运动提供了基础。<small style="font-style: italic; opacity: 0.5">（由 claude-3.5-sonnet 生成摘要）</small>
...
> [!quote]- 解题指导
> ![](https://img.memset0.cn/2024/04/03/ScO9HRN1.png)
...
> | 物体     | 转动惯量                                                                                                             | 例图                                                                                                               |
> | -------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
> | 细杆     | 垂直于杆、通过杆中心的轴<br />$$J=\dfrac{1}{12} ml^2$$<br /><br />垂直于杆、通过杆端点的轴<br />$$J=\dfrac 13 ml^2$$ | ![100](https://img.memset0.cn/2024/04/25/lavnw1MQ.png)<br />![100](https://img.memset0.cn/2024/04/25/GBxO4NKQ.png) |
> | 圆柱     | $$J=\dfrac 12 mR^2$$                                                                                                 | ![100](https://img.memset0.cn/2024/04/25/78DHckNs.png)                                                             |
> | 圆环     | $$J=mR^2$$                                                                                                           |                                                                                                                    |
> | 球体$^*$ | $$J=\dfrac 25 mR^2$$                                                                                                 | ![100](https://img.memset0.cn/2024/04/25/WugRFgsO.png)                                                             |
> | 球壳$^*$ | $$J=\dfrac 23 mR^2$$                                                                                                 | ![100](https://img.memset0.cn/2024/04/25/jg09QxPf.png)                                                             |
...
> [!quote]- 证明
>
> ![|400](https://img.memset0.cn/2024/04/24/5iTNkixt.png)
>
> ![|400](https://img.memset0.cn/2024/04/24/uAscexCP.png)
