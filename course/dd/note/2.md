...
### 3.1. 最小项与最大项 Minterm and Maxterm
...
![YgHQXOr3.png|702](https://static.memset0.cn/img/v6/2024/05/11/YgHQXOr3.png)

### 3.2. 积之和与和之积 Sum-of-Product and Product-of-Sum

TBD

化简得到的 SOP/POS（或者退一步的 SOM/POM）被称为二级电路。二级电路与多级电路相比，好处是时延少，代价是使用的逻辑门多。

### 3.3. “AND-OR” Simplification
...
![dcN7g5ue.png|594](https://static.memset0.cn/img/v6/2024/03/14/dcN7g5ue.png)
...
## 6. Additional Gates and Circuits
