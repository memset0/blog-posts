...
![](https://static.memset0.cn/img/v6/2024/06/18/jIQhYlB3.png)

> [!warning]
>
> 假设 $C_0$ 和 $C_1$ 不会同时为 $1$，可以认为是无关项，还注意 $C_0$ 和 $C_1$ 同时为 $0$ 时应有 $A\leftarrow A$，故可列出卡诺图如下。

> [!quote]- Answer
> ![](https://static.memset0.cn/img/v6/2024/06/18/XyKLmYd3.png)
